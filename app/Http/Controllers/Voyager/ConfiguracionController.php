...
class ConfiguracionController extends VoyagerBaseController
{
    ...
    { 
        ...
        return view('vendor.voyager.configuracion.show',['configure'=>$configure]);
    ...
    public function saveconfig(Request $request){
        ...
        $data = Configuration::find($request->id);
        if(count($data)>0){
            $configure = Configuration::find($request->id);
            $configure->title = $request->title;
            $configure->description = $request->description;
            $configure->keywords = $request->keywords;
            $configure->ogsite_name = $request->ogsite_name;
            $configure->ogtiype = $request->ogtype;
            $configure->ogurl = $request->ogurl;
            $configure->ogtitle = $request->ogtitle;
            $configure->ogdescription = $request->ogdescription;
            $configure->ogimagen = $request->ogimagen;
            $configure->analitycs = $request->analitycs;
            $configure->save();
        }else{

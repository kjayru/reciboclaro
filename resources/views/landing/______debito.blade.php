...
@section('content')
  ...
  <div class="page2">
    ...
    <div class="list__title type2" id="new-afil">
        ...
        <p class="first-text"> Del 01 al 31 de enero </p>
          ...
          <div class="content" id="contentmain">
            ...
            <div class="content__info">
              <ul>
                ...
                <li> Términos y condiciones de campaña: "Bono por débito automático" <a href="/assets/files/tyc-v2.pdf"/ target="_blank">aquí</a> </li>

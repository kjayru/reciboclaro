...
@section('content')
  ...
  <div class="page2">
    ...
    <div class="list__title type2" id="new-afil">
        ...
        <p class="first-text"> Del 01 de julio al 31 de julio </p>
                ...
                <li> 
                 <!-- Términos y condiciones de campaña: "Gift card Visa" <a href="/assets/files/TyCDebitoautomaticogiftcardsVISA.pdf"/ target="_blank">aquí</a> -->
                  ...
                  Mayor información sobre Débito Automático campaña GIFT CARD VISA
                   ...
                   <a href="http://conoceturecibo.com/pdf/TyCDebitoautomaticogiftcardsVISA.pdf" target="_blank">aquí</a> 
                </li>
                <li>
                  Términos y condiciones sobre la solicitud de afiliación al débito automático. Más información <a href="https://static.claro.com.pe/img/otros/TyCDebitoautomaticoCampanaMiClaro.pdf" target="_blank">aquí</a>
                </li>

      ...
      <section class="section3">
        <div class="section3__align">
          <div class="section3__header">
            <div class="title">
              <h2>Si te olvidaste de pagar tu recibo y te cortaron la línea</h2>
            </div>
          </div>
          <div class="section3__main">
            <div class="info">
              <p>En el siguiente video te explicamos lo que ocurre:  </p>
            </div>
            <div class="item">
              ...
              <span><a href="/dudas-sobre-tu-facturacion">Ver más escenarios</a></span>
            </div>

...
@section('content')
  ...
  <div class="page2">
    ...
    <div class="list__title type2" id="new-afil">
        ...
        <p class="first-text"> Del 01 de julio al 30 de setiembre </p>
        ...
        <p style="text-transform:uppercase; font-size: 25px; font-weight:500;">!Y, mantente siempre al día en tus pagos!. Sin colas, sin comisiones y sin salir de casa.</p>
        ...
        <div class="debito__consideraciones" style="font-style: italic; padding-top:1rem;">
          <p style="font-style: italic;">Válido para clientes masivo postpago claro que afilien su linea al débito automático del 01/07/21 al 30/09/21,
            siempre que realicen cargos exitosos. Conoce la cantidad de GB que se asignará según el plan contratado en los términos y condiciones
            de la promoción.
          </p>
        </div>
              ...
              <ul>
                ...
                <li> 
                 <!-- Términos y condiciones de campaña: "Gift card Visa" <a href="/assets/files/TyCDebitoautomaticogiftcardsVISA.pdf"/ target="_blank">aquí</a> -->
                  ...
                  Mayor información sobre Debito automático campaña Mi Claro <a href="https://static.claro.com.pe/img/otros/TyCDebitoautomaticoCampanaMiClaro.pdf" target="_blank">aquí</a> 
                </li>
                <li>
                  Términos y condiciones sobre la solicitud de afiliación al débito automático. Más información <a href="https://static.claro.com.pe/img/otros/TyCDebitoautomaticogiftcardsVISA.pdf" target="_blank">aquí</a>
                </li>

...
@section('content')
  ...
  <div class="page2">
    ...
    <div class="list__title type2" id="new-afil">
        ...
        <p class="first-text"> Del 06 de noviembre al 31 de diciembre</p>

        <h3> <b>AFÍLIATE AL </b> <span class="box-">DÉBITO AUTOMÁTICO</span> <br> Y PODRÍAS GANAR INCREÍBLES PREMIOS </h3>

        <p> Registra el pago de tus servicios de Claro al débito automático y participa de un celular.
Y con tu tarjeta Visa, Mastercard o Tarjeta oh!, a través de Niubiz, también participa del sorteo de una TV.

           </p>

          <div class="content__image">
             <img  src="/assets/niubiz-concurso.png"/ > <img src="/assets/visa.svg"/>  <img src="/assets/mastercard.svg"/> 

             <small style="order: 4; margin-top:  35px; font-size:  13px; display:  inline-block;  width:   100%;"  >  Para participar de cualquier sorteo, requerimos la afiliación y el primer cargo con éxito.</small>
          </div>
          ...
          <div class="content" id="contentmain">
            ...
            <div class="content__info">
              <ul>
                ...
                <li> Términos y condiciones de campaña: "Bono por débito automático" <a href="/assets/files/tyc.pdf"/ target="_blank">aquí</a> </li>

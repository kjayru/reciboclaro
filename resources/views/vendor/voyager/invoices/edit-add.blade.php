...
@section('page_title', __((isset($dataTypeContent->id) ? 'editar' : 'agregar')).' '.$dataType->display_name_singular)

@section('page_header')
    <h1 class="page-title">
        <i class="{{ $dataType->icon }}"></i>
        {{ __((isset($dataTypeContent->id) ? 'editar' : 'agregar')).' '.$dataType->display_name_singular }}
    </h1>

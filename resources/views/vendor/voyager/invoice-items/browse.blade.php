            ...
            <div class="col-md-12">
                <div class="panel panel-bordered">
                    <div class="panel-body">
                        ...
                        @endif
                        <H2>Incluya puntos de referencia</H2>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="no-sort no-click" id="bread-actions">
                                            ...
                                            @endcan
                                            <a href="/admin/invoice-items/implement/{{ $dataTypeContent[$key]->id }}" class="btn btn-sm btn-primary pull-right">
                                                <i class="voyager-eye"></i> <span class="hidden-xs hidden-sm">Implementar</span>
                                            </a>
                                        </td>
                                    </tr>
                                    @endforeach

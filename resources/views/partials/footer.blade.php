      ...
      <aside class="claro-havas-footer__bottom">
        ...
        <!--<script type="text/javascript" src="https://static.claro.com.pe/landings/havas/conoce_tu_recibo/js/main_v2.js"></script>-->
        ...
        @enddesktop
        @handheld
        <script src="/js/main-mobile.js?v={{uniqid()}}"></script>
        @endhandheld

...
<!--<div class="layout__header2">
    <div class="section1">
        <div class="section1__align"><div class="section1__header"><span><section id="navM"><div></div> <div></div> <div></div></section>
          <a href="/"><img src="https://static.claro.com.pe/landings/havas/conoce_tu_recibo/assets/claro.png"></a></span><span><ul><li id="nav">¿Qué necesitas saber?</li></ul></span></div></div></div>
    ...
    <div class="menuContenedor menuContenedor-newClass " id="menuContenedor" style="display: none;">
      <div class="limit limit--menu limit-newClass">
        <nav class="menu menu-newClass">
          <a class="menu__enlace menu-enlace-newClass" href="/como-leer-tu-recibo-movil"><img src="https://static.claro.com.pe/landings/havas/conoce_tu_recibo/assets/menu_image1.svg" alt="">¿Cómo leer tu recibo móvil?</a>
          <a class="menu__enlace menu-enlace-newClass" href="/lugares-de-pago"> <img src="https://static.claro.com.pe/landings/havas/conoce_tu_recibo/assets/menu_image2.svg" alt="">Lugares y medios de pago</a>


          <a class="menu__enlace menu-enlace-newClass" href="/lugares-de-pago/debito-automatico"><img src="https://static.claro.com.pe/landings/havas/conoce_tu_recibo/assets/menu_image3.svg" alt="">Afíliate al débito automático</a>

          <a class="menu__enlace menu-enlace-newClass" href="/dudas-sobre-tu-facturacion"> <img src="https://static.claro.com.pe/landings/havas/conoce_tu_recibo/assets/menu_image4.svg" alt="">¿Problemas con tu facturación?</a>

          <a class="menu__enlace menu-enlace-newClass" href="/glosario-de-facturacion"><img src="https://static.claro.com.pe/landings/havas/conoce_tu_recibo/assets/menu_image5.svg" alt="">Glosario </a>
          <a class="menu__enlace menu-enlace-newClass" href="/dudas-y-preguntas-frecuentes"><img src="https://static.claro.com.pe/landings/havas/conoce_tu_recibo/assets/menu_image6.svg" alt="">Dudas y preguntas frecuentes</a>

        </nav>
      </div>
      <div class="link link-newClass">
        <a href="/que-es-el-recibo-por-email">
          <span class="desktop desktop-newClass">Olvídate de las hojas impresas, afíliate al recibo por email <b>aquí</b></span>
          <span class="mobil mobil-newClass">Afíliate al recibo por email</span>
        </a>
      </div>
    </div>

  ...
  let tabBim = document.getElementById(`tab-${bim}`)
  ...
  let infoBim = document.getElementById(`info-${bim}`)
  ...
  if (pathnamePage === '/lugares-de-pago/banco-digital') {
    ...
    if (tabSearch == '#tab=bim') {
      tabBim.classList.add('act')
    ...
    listBank.addEventListener('click' , e  => {
      ...
      if (getId === 'tab-interbank' ) {
        ...
        tabBim.classList.remove('act')
        infoBim.classList.remove('active')
      }
